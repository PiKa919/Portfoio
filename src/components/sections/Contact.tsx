  ...
  return (
    <section id="contact" className="relative min-h-screen py-16 md:py-20">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-black/50 border ${
                    errors.name ? 'border-red-500' : 'border-cyan/30'
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-black/50 border ${
                    errors.email ? 'border-red-500' : 'border-cyan/30'
                  } rounded-lg px-4 py-3 font-mono text-white focus:outline-none focus:border-cyan transition-colors`}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className={`w-full bg-black/50 border ${
                    errors.message ? 'border-red-500' : 'border-cyan/30'
              ...
              <motion.button
                ...
                className={`w-full py-4 font-mono text-sm border-2 rounded-lg transition-all ${
                  isSubmitting
      ...
      <motion.footer
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="relative z-10 mt-20 pt-8 border-t border-cyan/10"
      >
